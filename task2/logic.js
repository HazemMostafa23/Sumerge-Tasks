...
function win(player) {
    ...
    if (btn_list[0] == player && btn_list[1] == player && btn_list[2] == player ||btn_list[0] == player && btn_list[3] == player && btn_list[6] == player
        || btn_list[0] == player && btn_list[4] == player && btn_list[8] == player||
       
        btn_list[1] == player && btn_list[4] == player && btn_list[7] == player||
        btn_list[2] == player && btn_list[5] == player && btn_list[8] == player||
        btn_list[3] == player && btn_list[4] == player && btn_list[5] == player||
        btn_list[6] == player && btn_list[7] == player && btn_list[8] == player||
        btn_list[6] == player && btn_list[4] == player && btn_list[2] == player) {
        if (player == "X") {
